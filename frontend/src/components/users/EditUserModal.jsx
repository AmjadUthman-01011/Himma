  ...
  return (
    <div>
      ...
      <input
        ...
        onChange={onChange}
        required={required}
        className="h-10 w-full rounded-sm border border-[#c5c5d3] px-3 text-sm outline-none focus:border-[#4e45d5] focus:ring-2 focus:ring-[#4e45d5]/20"
      />
    </div>
  );
}
...
function ModalShell({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4 backdrop-blur-sm">
      ...
      <div className="w-full max-w-lg overflow-hidden rounded-xl border border-[#e0e3e5] bg-white shadow-xl">
