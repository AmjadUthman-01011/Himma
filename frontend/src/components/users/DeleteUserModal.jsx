...
export default function DeleteUserModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4 backdrop-blur-sm">
      ...
      <div className="w-full max-w-md overflow-hidden rounded-sm border border-[#e0e3e5] bg-white shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-[#e0e3e5] px-5 py-4 sm:px-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex h-10 w-10 items-center justify-center rounded-sm bg-[#ffdad6]">
              <Trash2
                size={19}
        ...
        <div className="px-5 py-6 sm:px-6">
          ...
          <div className="flex gap-3 rounded-sm border border-[#ffdad6] bg-[#ffdad6]/40 p-4">
        ...
        <div className="flex flex-col-reverse gap-3 border-t border-[#e0e3e5] px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={loading}
            className="inline-flex h-10 items-center justify-center gap-2 rounded-sm bg-[#ba1a1a] px-5 text-sm font-semibold text-white transition hover:bg-[#93000a] disabled:cursor-not-allowed disabled:opacity-60"
          >
            {loading ? (
              <>
                <Loader2
