            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2">
                ...
                <select
                  ...
                  value={form.role}
                  onChange={handleChange}
                  className="h-10 w-full rounded-sm border border-[#c5c5d3] bg-white px-3 text-sm text-[#191c1e] outline-none transition focus:border-[#4e45d5] focus:ring-2 focus:ring-[#4e45d5]/20"
                >
  ...
  return (
    <div>
      ...
      <input
        ...
        required={required}
        className="h-10 w-full rounded-sm border border-[#c5c5d3] bg-white px-3 text-sm text-[#191c1e] outline-none transition placeholder:text-[#757682] focus:border-[#4e45d5] focus:ring-2 focus:ring-[#4e45d5]/20"
      />
    </div>
  );
}