      ...
      <div className="w-full max-w-md overflow-hidden rounded-xl border border-[#e0e3e5] bg-white shadow-xl">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="px-5 py-5 sm:px-6">
            ...
            <div className="mb-5 rounded-lg bg-[#f2f4f6] p-4">
            ...
            <select
              ...
              className="h-10 w-full rounded-lg border border-[#c5c5d3] bg-white px-3 text-sm text-[#191c1e] outline-none focus:border-[#4e45d5] focus:ring-2 focus:ring-[#4e45d5]/20"
            >
            ...
            {roleChanged && (
              <div className="mt-4 flex gap-3 rounded-lg border border-[#f0d9a6] bg-[#fff8e6] p-3">
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-[#e0e3e5] px-5 py-4 sm:flex-row sm:justify-end sm:px-6">
            ...
            <button
              ...
              className="inline-flex h-10 items-center justify-center gap-2 rounded-lg bg-[#1e3a8a] px-5 text-sm font-semibold text-white hover:bg-[#00236f] disabled:cursor-not-allowed disabled:opacity-50"
            >
              {loading && (
                <Loader2
                  size={17}
